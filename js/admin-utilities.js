(function ($) {
    ...
    i9idxLinkBuilder = {
        ...
        init: function () {
            ...
            if ($('#i9idxpress-assembled-url').val() == 'http://') {
            ...
            $('#i9idxpress-filter-menu').append($('<option>', { value: -1 }).text('Choose criteria...'));

            $.each(this.filters, function (key, filter) {

                $('#i9idxpress-filter-menu').append($('<option>', { value: key }).text(filter.name));
            ...
            $('#i9idxpress-filter-menu').change(function () {

                i9idxLinkBuilder.buildEditor(this);

            });



            $('#i9idxpress-link-builder').on('click', '.i9idx-editor-cancel', function () {

                i9idxLinkBuilder.cancelEditor();

            });



            $('#i9idxpress-link-builder').on('click', '.button-primary', function () {

                i9idxLinkBuilder.addFilter();

            });



            $('#i9idxpress-filter-list').on('click', 'li', function () {
            ...
            $('#i9idxpress-filter-list').on('click', 'li a', function (e) {

                i9idxLinkBuilder.removeFilter(this.parentNode);

                e.stopPropagation();

            });

            $('#i9idxpress-link-builder').on('click', '#idx-lookup-geocode-btn', function () {

                i9idxLinkBuilder.doRadiusGeocode();

            });

            $('#i9idxpress-link-builder .i9idxpress-checkbox input').click(function () {

                if (this.checked) {

                    $('#i9idxpress-assembled-url-wrap').removeClass('hidden');

                } else {

                    $('#i9idxpress-assembled-url-wrap').addClass('hidden');
            ...
            $('#submit-linkbuilderdiv').click(function (e) {
                ...
                wpNavMenu.addLinkToMenu($('#i9idxpress-assembled-url').val(), $('#i9idxpress-menu-item-label').val(), null, function () {

                    $('#img-link-builder-waiting').hide();

                    $('#i9idxpress-menu-item-label').val('').blur();

                    $('#i9idxpress-menu-item-url').val(i9idxLinkBuilder.resetUrl());

                    i9idxLinkBuilder.resetFilters();
        ...
        buildEditor: function (el, n) {
            ...
            if ($e.val() != '-1') {
                ...
                var fid = (n == 'li') ? el.id.replace('i9idxpress-filter-', '') : $e.val();

                var filter = this.filters[fid];

                var $w = $('#i9idxpress-editor-wrap');

                var lb = i9idxLinkBuilder, html = '';
                ...
                if(filter.autocomplete){
                    ...
                    html += '<div class="filter-autocomplete"><input type="text" placeholder="'+filter.autocomplete.label+'" id="i9idx-filter-autocomplete" /></div>';
                ...
                $w.find('.i9idxpress-editor-header h4 b').html(filter.name);

                $w.find('.i9idxpress-editor-main').html(html);
        ...
        buildAutoComplete: function(filter){
            ...
            if($('#i9idx-filter-autocomplete').data('ui-autocomplete') != undefined){

                $('#i9idx-filter-autocomplete').autocomplete('destroy');
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    $('#i9idx-filter-autocomplete').autocomplete({source:response, select: function(event, ui){i9idxLinkBuilder.handleAutocompleteSelect(event, ui, appendTo); $(this).val(''); return false;}});
        ...
        cancelEditor: function () {
            ...
            $('#i9idxpress-editor-wrap').addClass('hidden');
        ...
        disableSubmitOnEnterKey: function (){
            ...
            $(document).on('keypress', '#i9idxpress-link-builder input', function(e){
        ...
        addFilter: function () {
            ...
            var $e = $('#i9idxpress-filter-menu'), lb = i9idxLinkBuilder, active_filter = false, err = false, err_msg;
            ...
            if (err) {
                ...
                if ($('.i9idxpress-editor-main .i9idxpress-editor-error').length == 0) {

                    var msg = '<p class="i9idxpress-editor-error" style="font-weight: bold; color: #c00;">' + err_msg + '</p>';

                    $('.i9idxpress-editor-main').prepend(msg);
        ...
        addFilterToList: function (id) {
            ...
            var $w = $('#i9idxpress-filters-wrap'), $f = $('#i9idxpress-filter-list'), fid = 'i9idxpress-filter-' + id;
        ...
        removeFilter: function (el) {
            ...
            var id = el.id.replace('i9idxpress-filter-', '');
            ...
            $.each(filter.fields, function (i, field) {
                ...
                delete i9idxLinkBuilder.current_filters[field.id];
            ...
            if ($.isEmptyObject(this.current_filters)) {
                ...
                $('#i9idxpress-filters-wrap').addClass('hidden');

            }



            if ($('#i9idxpress-filter-menu').val() == id)
        ...
        resetFilters: function () {
            ...
            $('#i9idxpress-filter-list').empty();

            if (!$('#i9idxpress-filters-wrap').hasClass('hidden'))
        ...
        loadFiltersFromUrl: function () {
            ...
            var url = decodeURIComponent($('#i9idxpress-assembled-url').val()), lb = i9idxLinkBuilder;
                ...
                $.each(filter.fields, function (index, field) {
                    ...
                    switch (field.mode) {
                        ...
                        case 'lookup':
                            ...
                            var val = (field.id.indexOf('__i9idxINDEX__') != -1) ? lb.getQueryValue(url, field.id.replace('__i9idxINDEX__', '<0>')) : lb.getQueryValue(url, field.id);
                        ...
                        case 'multi':
                            ...
                            for (var i = 0; ; i++) {
                                ...
                                var val = (field.id.indexOf('__i9idxINDEX__') != -1) ? lb.getQueryValue(url, field.id.replace('__i9idxINDEX__', '<' + i + '>')) : lb.getQueryValue(url, field.id + '<' + i + '>');
        ...
        updateUrl: function () {
            ...
            $.each(this.current_filters, function (key, val) {
                ...
                if ($.isArray(val)) {
                    ...
                    $.each(val, function (i, v) {
                        ...
                        var k = key, pos = key.indexOf('__i9idxINDEX__');

                        if (pos > -1) {

                            k = [k.slice(0, pos), '<' + i + '>', k.slice(pos)].join('');

                            k = k.replace('__i9idxINDEX__', '');
                    ...
                    var pos = key.indexOf('__i9idxINDEX__');

                    key = (pos > -1) ? [key.slice(0, pos), '<0>', key.slice(pos)].join('') : key;

                    key = key.replace('__i9idxINDEX__', '');
            ...
            $('#i9idxpress-assembled-url').val($('#i9idxpress-assembled-url').val() + qs.join('&'));

        },

        resetUrl: function () {

            $('#i9idxpress-assembled-url').val(zpress_home_url + '/idx/?');
        ...
        resetMenu: function (val) {
            ...
            $('#i9idxpress-filter-menu').val(val);
        ...
        setupFieldsWithDefaultTitle: function () {
            ...
            $('#i9idxpress-editor-wrap .' + name).each(function () {
        ...
        filters: {
            ...
            schools: {
                ...
                fields: [

                    {
                        ...
                        id: 'idx-q-Schools__i9idxINDEX__-Name',
...

                    {
                        ...
                        id: 'idx-q-Schools__i9idxINDEX__-Type',
            ...
            cities: {
                ...
                autocomplete: {
                    ...
                    url: i9idxPluginUri + 'client-assist.php?action=LoadAreasByType',

                    args: {'type':'City', 'dataField':'Name'},

                    dataField: 'Name',

                    appendTo: 'canny-q-Cities',
            ...
            tracts: {
                ...
                autocomplete: {
                    ...
                    appendTo: 'canny-q-TractIdentifiers',
            ...
            open_houses: {
                ...
                help: 'Open House information available to i9idxpress PRO users only.',
            ...
            sort_columns: {
                ...
                fields: [

                    {
                        ...
                        id: 'idx-d-SortOrders__i9idxINDEX__-Column',
...

                    {
                        ...
                        id: 'idx-d-SortOrders__i9idxINDEX__-Direction',
        ...
        escapeHtmlEntities: function (text) {
            ...
            return text.replace(/[\u00A0-\u2666<>\&]/g, function (c) {
                ...
                return '&' + i9idxLinkBuilder.entityTable[c.charCodeAt(0)] + ';' || '#' + c.charCodeAt(0) + ';';
